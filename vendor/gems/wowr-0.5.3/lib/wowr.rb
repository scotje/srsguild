...
module Wowr
	class API
		...
		@@armory_base_url = 'armory.srsguild.com:8080/'
    ...
    @@calendar_detail_url = 'vault/calendar/detail.json'
		...
		@@user_agent = 'Mozilla/5.0 SrsguildArmoryBot/1.0'
      ...
      # Mucked around in here to support my proxy, broke the login stuff
      # I'm sure but I don't care about that. -JCS 11/10/10
			str += "wow/#{locale.downcase}/"
      ...
      # Always send me raw XML regardless of user agent. -JCS 11/10/10
			if url[-3,3] == 'xml'
			  params << "rhtml=n"
		  end
